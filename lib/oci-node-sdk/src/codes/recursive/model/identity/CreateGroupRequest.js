/**
 * A class that contains properties necessary to perform CreateGroup
 * @param {CreateGroupDetails} createGroupDetails An instance of {@link CreateGroupDetails}
...
class CreateGroupRequest {
	...
	constructor(createGroupDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createGroupDetails;
