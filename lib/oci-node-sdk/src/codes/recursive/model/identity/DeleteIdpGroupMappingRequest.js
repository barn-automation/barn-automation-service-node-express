/**
 * A class that contains properties necessary to perform DeleteIdpGroupMapping
 ...
 * @class DeleteIdpGroupMappingRequest
 */
class DeleteIdpGroupMappingRequest {

	constructor(identityProviderId, mappingId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteIdpGroupMappingRequest;