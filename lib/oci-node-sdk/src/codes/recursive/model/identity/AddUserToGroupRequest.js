/**
 * A class that contains properties necessary to perform AddUserToGroup
 * @param {AddUserToGroupDetails} addUserToGroupDetails An instance of {@link AddUserToGroupDetails}
...
class AddUserToGroupRequest {
	...
	constructor(addUserToGroupDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = addUserToGroupDetails;
...
module.exports = AddUserToGroupRequest;