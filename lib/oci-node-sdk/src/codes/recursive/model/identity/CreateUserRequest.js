/**
 * A class that contains properties necessary to perform CreateUser
 * @param {CreateUserDetails} createUserDetails An instance of {@link CreateUserDetails}
...
class CreateUserRequest {
	...
	constructor(createUserDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createUserDetails;
