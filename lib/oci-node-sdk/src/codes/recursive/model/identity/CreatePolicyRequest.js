/**
 * A class that contains properties necessary to perform CreatePolicy
 * @param {CreatePolicyDetails} createPolicyDetails An instance of {@link CreatePolicyDetails}
...
class CreatePolicyRequest {
	...
	constructor(createPolicyDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createPolicyDetails;
...
module.exports = CreatePolicyRequest;