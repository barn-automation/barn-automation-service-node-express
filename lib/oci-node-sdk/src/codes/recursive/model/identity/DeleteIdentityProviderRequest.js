/**
 * A class that contains properties necessary to perform DeleteIdentityProvider
...
class DeleteIdentityProviderRequest {
	...
	constructor(identityProviderId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteIdentityProviderRequest;