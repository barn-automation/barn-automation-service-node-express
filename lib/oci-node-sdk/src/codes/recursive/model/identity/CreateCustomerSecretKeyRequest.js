/**
 * A class that contains properties necessary to perform CreateCustomerSecretKey
 * @param {string} userId The OCID of the user.
 * @param {CreateCustomerSecretKeyDetails} createCustomerSecretKeyDetails An instance of {@link CreateCustomerSecretKeyDetails}
...
class CreateCustomerSecretKeyRequest {
	...
	constructor(userId, createCustomerSecretKeyDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createCustomerSecretKeyDetails;
		this.userId = userId;
...
module.exports = CreateCustomerSecretKeyRequest;