/**
 * A class that contains properties necessary to perform ListCostTrackingTags
 ...
 * @class ListCostTrackingTagsRequest
 */
class ListCostTrackingTagsRequest {

	constructor(compartmentId, page, limit){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListCostTrackingTagsRequest;