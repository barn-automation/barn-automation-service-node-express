/**
 * A class that contains properties necessary to perform CreateOrResetUIPassword
 ...
 * @class CreateOrResetUIPasswordRequest
 */
class CreateOrResetUIPasswordRequest {

	constructor(userId, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = CreateOrResetUIPasswordRequest;