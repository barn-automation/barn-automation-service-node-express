...
* @param {CreateDbHomeDetails} dbHome 
...
* @param {string} [source] The source of the database: NONE for creating a new database. DB_BACKUP for creating a new database by restoring from a backup. The default is NONE. Required value: NONE See {@link LaunchDbSystemBase} for more information.
...
* @param {string} [diskRedundancy] The type of redundancy configured for the DB system. Normal is 2-way redundancy, recommended for test and development systems. High is 3-way redundancy, recommended for production systems. Allowed values are: HIGH NORMAL
...
module.exports = LaunchDbSystemDetails;
