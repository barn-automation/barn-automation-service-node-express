/**
 * A class that contains properties necessary to perform TerminateDbSystem
 ...
 * @class TerminateDbSystemRequest
 */
class TerminateDbSystemRequest {

	constructor(dbSystemId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = TerminateDbSystemRequest;