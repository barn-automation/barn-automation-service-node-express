/**
 * A class that contains properties necessary to perform GetDbHomePatchHistoryEntry
 ...
 * @class GetDbHomePatchHistoryEntryRequest
 */
class GetDbHomePatchHistoryEntryRequest {

	constructor(dbHomeId, patchHistoryEntryId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = GetDbHomePatchHistoryEntryRequest;