/**
 * A class that contains properties necessary to perform CreateBackup
 * @param {CreateBackupDetails} createBackupDetails An instance of {@link CreateBackupDetails}
...
class CreateBackupRequest {
	...
	constructor(createBackupDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createBackupDetails;
...
module.exports = CreateBackupRequest;