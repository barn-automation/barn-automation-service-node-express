...
* @param {string} id Minimum: 1 Maximum: 255 The {@link https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm|OCID} of the Autonomous Database.
* @param {string} lifecycleState The current state of the database. Allowed values are: PROVISIONING AVAILABLE STOPPING STOPPED STARTING TERMINATING TERMINATED UNAVAILABLE RESTORE_IN_PROGRESS RESTORE_FAILED BACKUP_IN_PROGRESS SCALE_IN_PROGRESS AVAILABLE_NEEDS_ATTENTION
* @param {AutonomousDatabaseConnectionStrings} [connectionStrings] The connection string used to connect to the Autonomous Database. The username for the Service Console is ADMIN. Use the password you entered when creating the Autonomous Database for the password value.
...
* @param {string} [serviceConsoleUrl] Minimum: 10 Maximum: 255 The URL of the Service Console for the Autonomous Database.
...
module.exports = AutonomousDatabaseSummary;
