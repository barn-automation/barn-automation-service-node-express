...
* @param {string} compartmentId Minimum: 1 Maximum: 255 The {@link https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm|OCID} of the compartment of the Autonomous Data Warehouse.
* @param {number} cpuCoreCount The number of CPU Cores to be made available to the database.
* @param {number} dataStorageSizeInTBs Size, in terabytes, of the data volume that will be created and attached to the database. This storage can later be scaled up if needed.
...
* @class CreateAutonomousDataWarehouseDetails
*/
class CreateAutonomousDataWarehouseDetails {
...
module.exports = CreateAutonomousDataWarehouseDetails;
