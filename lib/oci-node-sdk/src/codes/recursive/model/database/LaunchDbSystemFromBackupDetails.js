...
* @param {string} databaseEdition The Oracle Database Edition that applies to all the databases on the DB system. Exadata DB systems and 2-node RAC DB systems require ENTERPRISE_EDITION_EXTREME_PERFORMANCE. Allowed values are: STANDARD_EDITION ENTERPRISE_EDITION ENTERPRISE_EDITION_HIGH_PERFORMANCE ENTERPRISE_EDITION_EXTREME_PERFORMANCE
* @param {CreateDbHomeFromBackupDetails} dbHome 
...
* @param {string} [source] The source of the database: NONE for creating a new database. DB_BACKUP for creating a new database by restoring from a backup. The default is NONE. Required value: DB_BACKUP See {@link LaunchDbSystemBase} for more information.
...
* @param {string} [diskRedundancy] The type of redundancy configured for the DB system. NORMAL 2-way redundancy, recommended for test and development systems. HIGH is 3-way redundancy, recommended for production systems. Allowed values are: HIGH NORMAL
...
*/
class LaunchDbSystemFromBackupDetails {
	constructor(availabilityDomain, compartmentId, cpuCoreCount, hostname, shape, sshPublicKeys, subnetId, databaseEdition, dbHome, backupSubnetId, clusterName, dataStoragePercentage, definedTags, displayName, domain, faultDomains, freeformTags, initialDataStorageSizeInGB, nodeCount, source, sparseDiskgroup, diskRedundancy, licenseModel){
...
module.exports = LaunchDbSystemFromBackupDetails;
