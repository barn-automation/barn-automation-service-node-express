/**
 * A class that contains properties necessary to perform FailoverDataGuardAssociation
 ...
 * @param {FailoverDataGuardAssociationDetails} failoverDataGuardAssociationDetails An instance of {@link FailoverDataGuardAssociationDetails}
 * @param {string} [ifMatch] For optimistic concurrency control. In the PUT or DELETE call for a resource, set the if-match parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
 * @class FailoverDataGuardAssociationRequest
 */
class FailoverDataGuardAssociationRequest {

	constructor(databaseId, dataGuardAssociationId, failoverDataGuardAssociationDetails, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = failoverDataGuardAssociationDetails;
...
module.exports = FailoverDataGuardAssociationRequest;