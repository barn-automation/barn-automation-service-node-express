/**
 * A class that contains properties necessary to perform ListAutonomousDataWarehouses
 ...
 * @class ListAutonomousDataWarehousesRequest
 */
class ListAutonomousDataWarehousesRequest {

	constructor(compartmentId, limit, page, sortBy, sortOrder, lifecycleState, displayName){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListAutonomousDataWarehousesRequest;