/**
 * A class that contains properties necessary to perform ListAutonomousDatabases
...
class ListAutonomousDatabasesRequest {
	...
	constructor(compartmentId, limit, page, sortBy, sortOrder, lifecycleState, displayName, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListAutonomousDatabasesRequest;