/**
 * A class that contains properties necessary to perform ListSubscriptions
 ...
 * @param {string} [topicId] Minimum: 1 Maximum: 255 Return all subscriptions that are subscribed to the given topic OCID. Either this query parameter or the compartmentId query parameter must be set.
...
class ListSubscriptionsRequest {
	...
	constructor(compartmentId, topicId, page, limit, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get queryParams(){
		...
		this._queryParams['topicId'] = this.topicId;
...
module.exports = ListSubscriptionsRequest;