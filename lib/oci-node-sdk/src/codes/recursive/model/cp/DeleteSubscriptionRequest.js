/**
 * A class that contains properties necessary to perform DeleteSubscription
 * @param {string} subscriptionId The {@link https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm|OCID} of the subscription to delete.
...
class DeleteSubscriptionRequest {
	...
	constructor(subscriptionId, opcRequestId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteSubscriptionRequest;