/**
 * A class that contains properties necessary to perform GetVolumeBackupPolicyAssetAssignment
 * @param {string} assetId The OCID of an asset (e.g. a volume).
 ...
 * @class GetVolumeBackupPolicyAssetAssignmentRequest
 */
class GetVolumeBackupPolicyAssetAssignmentRequest {

	constructor(assetId, limit, page){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get queryParams(){
		this._queryParams['assetId'] = this.assetId;
...
module.exports = GetVolumeBackupPolicyAssetAssignmentRequest;