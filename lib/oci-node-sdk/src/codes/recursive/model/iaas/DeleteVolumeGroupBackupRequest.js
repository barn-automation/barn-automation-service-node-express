/**
 * A class that contains properties necessary to perform DeleteVolumeGroupBackup
 ...
 * @class DeleteVolumeGroupBackupRequest
 */
class DeleteVolumeGroupBackupRequest {

	constructor(volumeGroupBackupId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteVolumeGroupBackupRequest;