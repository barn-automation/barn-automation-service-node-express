/**
 * A class that contains properties necessary to perform ListInstances
...
class ListInstancesRequest {
	...
	constructor(compartmentId, availabilityDomain, displayName, limit, page, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListInstancesRequest;