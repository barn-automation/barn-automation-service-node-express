/**
 * A class that contains properties necessary to perform UpdateLoadBalancer
 * @param {string} loadBalancerId The {@link https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm|OCID} of the load balancer to update.
 * @param {UpdateLoadBalancerDetails} updateLoadBalancerDetails An instance of {@link UpdateLoadBalancerDetails}
...
class UpdateLoadBalancerRequest {
	...
	constructor(loadBalancerId, updateLoadBalancerDetails, opcRequestId, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateLoadBalancerDetails;
...
module.exports = UpdateLoadBalancerRequest;