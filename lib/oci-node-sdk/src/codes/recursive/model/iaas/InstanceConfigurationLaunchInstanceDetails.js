...
* @param {InstanceConfigurationCreateVnicDetails} [createVnicDetails] Details for the primary VNIC, which is automatically created and attached when the instance is launched.
...
* @param {InstanceConfigurationInstanceSourceDetails} [sourceDetails] Details for creating an instance. Use this parameter to specify whether a boot volume or an image should be used to launch a new instance.
* @class InstanceConfigurationLaunchInstanceDetails
*/
class InstanceConfigurationLaunchInstanceDetails {
	constructor(availabilityDomain, compartmentId, createVnicDetails, definedTags, displayName, extendedMetadata, freeformTags, ipxeScript, metadata, shape, sourceDetails){
...
module.exports = InstanceConfigurationLaunchInstanceDetails;
