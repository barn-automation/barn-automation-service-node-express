/**
 * A class that contains properties necessary to perform ListVolumeBackups
 ...
 * @param {string} [sourceVolumeBackupId] Minimum: 1 Maximum: 255 A filter to return only resources that originated from the given source volume backup.
...
class ListVolumeBackupsRequest {
	...
	constructor(compartmentId, volumeId, limit, page, displayName, sourceVolumeBackupId, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get queryParams(){
		...
		this._queryParams['sourceVolumeBackupId'] = this.sourceVolumeBackupId;
...
module.exports = ListVolumeBackupsRequest;