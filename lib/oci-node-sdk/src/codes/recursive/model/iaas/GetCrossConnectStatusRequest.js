/**
 * A class that contains properties necessary to perform GetCrossConnectStatus
 * @param {string} crossConnectId Minimum: 1 Maximum: 255 The OCID of the cross-connect.
 * @class GetCrossConnectStatusRequest
 */
class GetCrossConnectStatusRequest {
...
module.exports = GetCrossConnectStatusRequest;