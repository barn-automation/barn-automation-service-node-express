/**
 * A class that contains properties necessary to perform ListBootVolumeBackups
 ...
 * @class ListBootVolumeBackupsRequest
 */
class ListBootVolumeBackupsRequest {

	constructor(compartmentId, bootVolumeId, limit, page, displayName, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListBootVolumeBackupsRequest;