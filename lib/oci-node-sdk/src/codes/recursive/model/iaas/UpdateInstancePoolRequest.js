/**
 * A class that contains properties necessary to perform UpdateInstancePool
 * @param {string} instancePoolId The OCID of the instance pool.
 * @param {UpdateInstancePoolDetails} updateInstancePoolDetails An instance of {@link UpdateInstancePoolDetails}
...
class UpdateInstancePoolRequest {
	...
	constructor(instancePoolId, updateInstancePoolDetails, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateInstancePoolDetails;
...
module.exports = UpdateInstancePoolRequest;