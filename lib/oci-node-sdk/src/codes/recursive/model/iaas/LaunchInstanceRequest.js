/**
 * A class that contains properties necessary to perform LaunchInstance
 * @param {LaunchInstanceDetails} launchInstanceDetails An instance of {@link LaunchInstanceDetails}
...
class LaunchInstanceRequest {
	...
	constructor(launchInstanceDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = launchInstanceDetails;
...
module.exports = LaunchInstanceRequest;