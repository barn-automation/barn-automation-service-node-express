/**
 * A class that contains properties necessary to perform ExportImage
 * @param {string} imageId The OCID of the image.
 * @param {ExportImageDetails} exportImageDetails An instance of {@link ExportImageDetails}
...
class ExportImageRequest {
	...
	constructor(imageId, exportImageDetails, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = exportImageDetails;
...
module.exports = ExportImageRequest;