/**
 * A class that contains properties necessary to perform CreateImage
 * @param {CreateImageDetails} createImageDetails An instance of {@link CreateImageDetails}
...
class CreateImageRequest {
	...
	constructor(createImageDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createImageDetails;
