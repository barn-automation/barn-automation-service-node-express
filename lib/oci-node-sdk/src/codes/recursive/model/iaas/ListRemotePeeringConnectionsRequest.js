/**
 * A class that contains properties necessary to perform ListRemotePeeringConnections
 ...
 * @class ListRemotePeeringConnectionsRequest
 */
class ListRemotePeeringConnectionsRequest {

	constructor(compartmentId, drgId, limit, page){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListRemotePeeringConnectionsRequest;