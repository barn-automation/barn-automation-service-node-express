/**
 * A class that contains properties necessary to perform ListInstanceConsoleConnections
 ...
 * @class ListInstanceConsoleConnectionsRequest
 */
class ListInstanceConsoleConnectionsRequest {

	constructor(compartmentId, instanceId, limit, page){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListInstanceConsoleConnectionsRequest;