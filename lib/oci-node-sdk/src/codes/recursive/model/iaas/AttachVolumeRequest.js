/**
 * A class that contains properties necessary to perform AttachVolume
 * @param {AttachVolumeDetails} attachVolumeDetails An instance of {@link AttachVolumeDetails}
...
class AttachVolumeRequest {
	...
	constructor(attachVolumeDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = attachVolumeDetails;
...
module.exports = AttachVolumeRequest;