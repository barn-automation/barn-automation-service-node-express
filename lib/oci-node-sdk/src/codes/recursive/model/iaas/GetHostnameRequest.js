/**
 * A class that contains properties necessary to perform GetHostname
 ...
 * @param {string} name The name of the hostname resource to retrieve. Example: example_hostname_001
...
module.exports = GetHostnameRequest;