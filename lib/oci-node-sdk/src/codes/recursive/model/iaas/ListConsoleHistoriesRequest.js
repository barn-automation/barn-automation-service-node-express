/**
 * A class that contains properties necessary to perform ListConsoleHistories
 ...
 * @class ListConsoleHistoriesRequest
 */
class ListConsoleHistoriesRequest {

	constructor(compartmentId, availabilityDomain, limit, page, instanceId, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListConsoleHistoriesRequest;