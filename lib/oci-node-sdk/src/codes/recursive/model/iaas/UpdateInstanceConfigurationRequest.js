/**
 * A class that contains properties necessary to perform UpdateInstanceConfiguration
 * @param {string} instanceConfigurationId The OCID of the instance configuration.
 * @param {UpdateInstanceConfigurationDetails} updateInstanceConfigurationDetails An instance of {@link UpdateInstanceConfigurationDetails}
...
class UpdateInstanceConfigurationRequest {
	...
	constructor(instanceConfigurationId, updateInstanceConfigurationDetails, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateInstanceConfigurationDetails;
...
module.exports = UpdateInstanceConfigurationRequest;