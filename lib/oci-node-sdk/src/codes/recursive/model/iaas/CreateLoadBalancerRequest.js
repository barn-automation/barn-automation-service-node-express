/**
 * A class that contains properties necessary to perform CreateLoadBalancer
 * @param {CreateLoadBalancerDetails} createLoadBalancerDetails An instance of {@link CreateLoadBalancerDetails}
...
class CreateLoadBalancerRequest {
	...
	constructor(createLoadBalancerDetails, opcRequestId, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createLoadBalancerDetails;
...
module.exports = CreateLoadBalancerRequest;