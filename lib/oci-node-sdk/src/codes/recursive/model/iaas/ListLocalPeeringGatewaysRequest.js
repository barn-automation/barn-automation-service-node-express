/**
 * A class that contains properties necessary to perform ListLocalPeeringGateways
 ...
 * @class ListLocalPeeringGatewaysRequest
 */
class ListLocalPeeringGatewaysRequest {

	constructor(compartmentId, vcnId, limit, page){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListLocalPeeringGatewaysRequest;