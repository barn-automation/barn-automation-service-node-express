/**
 * A class that contains properties necessary to perform ListAppCatalogSubscriptions
 ...
 * @param {string} [listingId] Minimum: 1 Maximum: 255 A filter to return only the listings that matches the given listing id.
 * @class ListAppCatalogSubscriptionsRequest
 */
class ListAppCatalogSubscriptionsRequest {

	constructor(compartmentId, limit, page, sortBy, sortOrder, listingId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListAppCatalogSubscriptionsRequest;