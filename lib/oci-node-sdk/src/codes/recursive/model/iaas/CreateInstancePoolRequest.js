/**
 * A class that contains properties necessary to perform CreateInstancePool
 * @param {CreateInstancePoolDetails} createInstancePoolDetails An instance of {@link CreateInstancePoolDetails}
...
class CreateInstancePoolRequest {
	...
	constructor(createInstancePoolDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createInstancePoolDetails;
...
module.exports = CreateInstancePoolRequest;