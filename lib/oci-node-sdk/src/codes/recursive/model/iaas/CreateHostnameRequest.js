/**
 * A class that contains properties necessary to perform CreateHostname
 * @param {string} loadBalancerId The {@link https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm|OCID} of the load balancer to add the hostname to.
 * @param {CreateHostnameDetails} createHostnameDetails An instance of {@link CreateHostnameDetails}
...
class CreateHostnameRequest {
	...
	constructor(loadBalancerId, createHostnameDetails, opcRequestId, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createHostnameDetails;
...
module.exports = CreateHostnameRequest;