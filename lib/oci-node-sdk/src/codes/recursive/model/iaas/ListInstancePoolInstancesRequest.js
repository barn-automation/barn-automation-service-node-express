/**
 * A class that contains properties necessary to perform ListInstancePoolInstances
 ...
 * @class ListInstancePoolInstancesRequest
 */
class ListInstancePoolInstancesRequest {

	constructor(instancePoolId, compartmentId, displayName, limit, page, sortBy, sortOrder){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListInstancePoolInstancesRequest;