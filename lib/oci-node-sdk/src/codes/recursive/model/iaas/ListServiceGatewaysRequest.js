/**
 * A class that contains properties necessary to perform ListServiceGateways
 ...
 * @param {string} [lifecycleState] A filter to return only resources that match the given lifecycle state. The state value is case-insensitive.
 * @class ListServiceGatewaysRequest
 */
class ListServiceGatewaysRequest {

	constructor(compartmentId, vcnId, limit, page, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListServiceGatewaysRequest;