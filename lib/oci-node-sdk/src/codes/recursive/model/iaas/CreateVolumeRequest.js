/**
 * A class that contains properties necessary to perform CreateVolume
 * @param {CreateVolumeDetails} createVolumeDetails An instance of {@link CreateVolumeDetails}
...
class CreateVolumeRequest {
	...
	constructor(createVolumeDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createVolumeDetails;
...
module.exports = CreateVolumeRequest;