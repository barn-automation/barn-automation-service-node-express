/**
 * A class that contains properties necessary to perform UpdateInstance
 * @param {string} instanceId The OCID of the instance.
 * @param {UpdateInstanceDetails} updateInstanceDetails An instance of {@link UpdateInstanceDetails}
...
class UpdateInstanceRequest {
	...
	constructor(instanceId, updateInstanceDetails, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateInstanceDetails;
...
module.exports = UpdateInstanceRequest;