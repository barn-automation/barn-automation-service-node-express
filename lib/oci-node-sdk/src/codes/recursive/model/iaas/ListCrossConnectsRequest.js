/**
 * A class that contains properties necessary to perform ListCrossConnects
 ...
 * @param {string} [lifecycleState] A filter to return only resources that match the specified lifecycle state. The value is case insensitive.
 * @class ListCrossConnectsRequest
 */
class ListCrossConnectsRequest {

	constructor(compartmentId, crossConnectGroupId, limit, page, displayName, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get queryParams(){
		...
		this._queryParams['crossConnectGroupId'] = this.crossConnectGroupId;
...
module.exports = ListCrossConnectsRequest;