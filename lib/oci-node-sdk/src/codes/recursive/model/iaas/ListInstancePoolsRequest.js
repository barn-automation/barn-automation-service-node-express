/**
 * A class that contains properties necessary to perform ListInstancePools
...
class ListInstancePoolsRequest {
	...
	constructor(compartmentId, displayName, limit, page, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListInstancePoolsRequest;