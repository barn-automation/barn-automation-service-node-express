/**
 * A class that contains properties necessary to perform DeleteServiceGateway
 ...
 * @class DeleteServiceGatewayRequest
 */
class DeleteServiceGatewayRequest {

	constructor(serviceGatewayId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteServiceGatewayRequest;