/**
 * A class that contains properties necessary to perform ListCrossConnectGroups
 ...
 * @class ListCrossConnectGroupsRequest
 */
class ListCrossConnectGroupsRequest {

	constructor(compartmentId, limit, page, displayName, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListCrossConnectGroupsRequest;