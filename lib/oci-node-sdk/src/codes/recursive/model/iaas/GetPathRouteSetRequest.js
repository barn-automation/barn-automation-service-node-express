/**
 * A class that contains properties necessary to perform GetPathRouteSet
 ...
 * @param {string} pathRouteSetName The name of the path route set to retrieve. Example: example_path_route_set
...
module.exports = GetPathRouteSetRequest;