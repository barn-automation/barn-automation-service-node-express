/**
 * A class that contains properties necessary to perform ListVolumeGroupBackups
 ...
 * @class ListVolumeGroupBackupsRequest
 */
class ListVolumeGroupBackupsRequest {

	constructor(compartmentId, volumeGroupId, limit, page, displayName, sortBy, sortOrder){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListVolumeGroupBackupsRequest;