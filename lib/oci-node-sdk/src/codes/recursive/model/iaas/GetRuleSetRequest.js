/**
 * A class that contains properties necessary to perform GetRuleSet
 ...
 * @param {string} ruleSetName The name of the rule set to retrieve. Example: example_rule_set
...
module.exports = GetRuleSetRequest;