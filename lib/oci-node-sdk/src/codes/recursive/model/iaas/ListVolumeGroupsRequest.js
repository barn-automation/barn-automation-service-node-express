/**
 * A class that contains properties necessary to perform ListVolumeGroups
 ...
 * @class ListVolumeGroupsRequest
 */
class ListVolumeGroupsRequest {

	constructor(compartmentId, availabilityDomain, limit, page, displayName, sortBy, sortOrder, lifecycleState){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListVolumeGroupsRequest;