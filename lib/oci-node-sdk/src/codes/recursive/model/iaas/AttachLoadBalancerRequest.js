/**
 * A class that contains properties necessary to perform AttachLoadBalancer
 * @param {string} instancePoolId The OCID of the instance pool.
 * @param {AttachLoadBalancerDetails} attachLoadBalancerDetails An instance of {@link AttachLoadBalancerDetails}
 ...
 * @class AttachLoadBalancerRequest
 */
class AttachLoadBalancerRequest {

	constructor(instancePoolId, attachLoadBalancerDetails, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = attachLoadBalancerDetails;
...
module.exports = AttachLoadBalancerRequest;