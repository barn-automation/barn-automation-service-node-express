/**
 * A class that contains properties necessary to perform CreateNatGateway
 * @param {CreateNatGatewayDetails} createNatGatewayDetails An instance of {@link CreateNatGatewayDetails}
...
class CreateNatGatewayRequest {
	...
	constructor(createNatGatewayDetails, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createNatGatewayDetails;
...
module.exports = CreateNatGatewayRequest;