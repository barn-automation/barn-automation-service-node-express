/**
 * A class that contains properties necessary to perform UpdateRuleSet
 ...
 * @param {string} ruleSetName The name of the rule set to update. Example: example_rule_set
 * @param {UpdateRuleSetDetails} updateRuleSetDetails An instance of {@link UpdateRuleSetDetails}
...
class UpdateRuleSetRequest {
	...
	constructor(loadBalancerId, ruleSetName, updateRuleSetDetails, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateRuleSetDetails;
...
module.exports = UpdateRuleSetRequest;