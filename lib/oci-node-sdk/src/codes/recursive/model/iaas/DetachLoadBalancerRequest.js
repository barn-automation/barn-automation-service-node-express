/**
 * A class that contains properties necessary to perform DetachLoadBalancer
 * @param {string} instancePoolId The OCID of the instance pool.
 * @param {DetachLoadBalancerDetails} detachLoadBalancerDetails An instance of {@link DetachLoadBalancerDetails}
 ...
 * @class DetachLoadBalancerRequest
 */
class DetachLoadBalancerRequest {

	constructor(instancePoolId, detachLoadBalancerDetails, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = detachLoadBalancerDetails;
...
module.exports = DetachLoadBalancerRequest;