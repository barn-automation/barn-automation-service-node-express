/**
 * A class that contains properties necessary to perform DeleteStream
 * @param {string} streamId Minimum: 1 Maximum: 1024 The OCID of the stream to delete.
...
module.exports = DeleteStreamRequest;