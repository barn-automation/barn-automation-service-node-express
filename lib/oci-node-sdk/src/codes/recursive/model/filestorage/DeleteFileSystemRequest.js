/**
 * A class that contains properties necessary to perform DeleteFileSystem
...
class DeleteFileSystemRequest {
	...
	constructor(fileSystemId, ifMatch, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteFileSystemRequest;