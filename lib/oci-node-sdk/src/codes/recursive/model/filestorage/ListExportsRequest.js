/**
 * A class that contains properties necessary to perform ListExports
 ...
 * @param {string} [sortBy] The field to sort by. You can provide either value, but not both. By default, when you sort by time created, results are shown in descending order. When you sort by path, results are shown in ascending alphanumeric order. Allowed values are: TIMECREATED PATH
...
class ListExportsRequest {
	...
	constructor(compartmentId, limit, page, exportSetId, fileSystemId, lifecycleState, id, sortBy, sortOrder, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListExportsRequest;