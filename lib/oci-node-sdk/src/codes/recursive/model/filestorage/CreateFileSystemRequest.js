/**
 * A class that contains properties necessary to perform CreateFileSystem
 * @param {CreateFileSystemDetails} createFileSystemDetails An instance of {@link CreateFileSystemDetails}
...
class CreateFileSystemRequest {
	...
	constructor(createFileSystemDetails, opcRetryToken, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createFileSystemDetails;
...
module.exports = CreateFileSystemRequest;