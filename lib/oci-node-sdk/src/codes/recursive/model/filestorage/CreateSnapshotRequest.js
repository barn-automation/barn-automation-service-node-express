/**
 * A class that contains properties necessary to perform CreateSnapshot
 * @param {CreateSnapshotDetails} createSnapshotDetails An instance of {@link CreateSnapshotDetails}
...
class CreateSnapshotRequest {
	...
	constructor(createSnapshotDetails, opcRetryToken, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createSnapshotDetails;
...
module.exports = CreateSnapshotRequest;