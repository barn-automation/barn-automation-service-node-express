/**
 * A class that contains properties necessary to perform ListMountTargets
 ...
 * @param {string} [lifecycleState] Filter results by the specified lifecycle state. Must be a valid state for the resource type. Allowed values are: CREATING ACTIVE DELETING DELETED FAILED
 * @param {string} [id] Minimum: 1 Maximum: 255 Filter results by OCID. Must be an OCID of the correct type for the resouce type.
 * @param {string} [sortBy] The field to sort by. You can choose either value, but not both. By default, when you sort by time created, results are shown in descending order. When you sort by display name, results are shown in ascending order. Allowed values are: TIMECREATED DISPLAYNAME
...
class ListMountTargetsRequest {
	...
	constructor(compartmentId, availabilityDomain, limit, page, displayName, exportSetId, lifecycleState, id, sortBy, sortOrder, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get queryParams(){
		...
		this._queryParams['exportSetId'] = this.exportSetId;
...
module.exports = ListMountTargetsRequest;