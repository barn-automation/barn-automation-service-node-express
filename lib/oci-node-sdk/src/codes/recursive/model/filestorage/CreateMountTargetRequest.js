/**
 * A class that contains properties necessary to perform CreateMountTarget
 * @param {CreateMountTargetDetails} createMountTargetDetails An instance of {@link CreateMountTargetDetails}
...
class CreateMountTargetRequest {
	...
	constructor(createMountTargetDetails, opcRetryToken, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createMountTargetDetails;
...
module.exports = CreateMountTargetRequest;