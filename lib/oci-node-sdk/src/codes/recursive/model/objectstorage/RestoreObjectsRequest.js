/**
 * A class that contains properties necessary to perform RestoreObjects
 ...
 * @param {RestoreObjectsDetails} restoreObjectsDetails An instance of {@link RestoreObjectsDetails}
 * @param {string} [opcClientRequestId] The client request ID for tracing.
 * @class RestoreObjectsRequest
 */
class RestoreObjectsRequest {

	constructor(namespaceName, bucketName, restoreObjectsDetails, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = restoreObjectsDetails;
...
module.exports = RestoreObjectsRequest;