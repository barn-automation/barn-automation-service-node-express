/**
 * A class that contains properties necessary to perform DeleteBucket
...
class DeleteBucketRequest {
	...
	constructor(namespaceName, bucketName, ifMatch, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteBucketRequest;