/**
 * A class that contains properties necessary to perform ListWorkRequestErrors
 ...
 * @class ListWorkRequestErrorsRequest
 */
class ListWorkRequestErrorsRequest {

	constructor(workRequestId, page, limit, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListWorkRequestErrorsRequest;