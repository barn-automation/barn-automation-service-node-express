/**
 * A class that contains properties necessary to perform RenameObject
 ...
 * @param {RenameObjectDetails} renameObjectDetails An instance of {@link RenameObjectDetails}
 * @param {string} [opcClientRequestId] The client request ID for tracing.
 * @class RenameObjectRequest
 */
class RenameObjectRequest {

	constructor(namespaceName, bucketName, renameObjectDetails, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = renameObjectDetails;
...
module.exports = RenameObjectRequest;