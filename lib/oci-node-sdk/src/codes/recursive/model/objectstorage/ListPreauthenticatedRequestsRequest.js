/**
 * A class that contains properties necessary to perform ListPreauthenticatedRequests
 ...
 * @param {string} [objectNamePrefix] User-specified object name prefixes can be used to query and return a list of pre-authenticated requests.
 ...
 * @class ListPreauthenticatedRequestsRequest
 */
class ListPreauthenticatedRequestsRequest {

	constructor(namespaceName, bucketName, objectNamePrefix, limit, page, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get queryParams(){
		this._queryParams['objectNamePrefix'] = this.objectNamePrefix;
...
module.exports = ListPreauthenticatedRequestsRequest;