/**
 * A class that contains properties necessary to perform UploadPart
 ...
 * @param {number} uploadPartNum The part number that identifies the object part currently being uploaded.
 * @param {Buffer} uploadPartBody The request body
...
class UploadPartRequest {
	...
	constructor(namespaceName, bucketName, objectName, uploadId, uploadPartNum, uploadPartBody, contentLength, opcClientRequestId, ifMatch, ifNoneMatch, expect, contentMD5){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = uploadPartBody;
	...
	get queryParams(){
		...
		this._queryParams['uploadPartNum'] = this.uploadPartNum;
