/**
 * A class that contains properties necessary to perform CreateMultipartUpload
 ...
 * @param {CreateMultipartUploadDetails} createMultipartUploadDetails An instance of {@link CreateMultipartUploadDetails}
...
class CreateMultipartUploadRequest {
	...
	constructor(namespaceName, bucketName, createMultipartUploadDetails, ifMatch, ifNoneMatch, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createMultipartUploadDetails;
...
module.exports = CreateMultipartUploadRequest;