/**
 * A class that contains properties necessary to perform HeadObject
...
class HeadObjectRequest {
	...
	constructor(namespaceName, bucketName, objectName, ifMatch, ifNoneMatch, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
