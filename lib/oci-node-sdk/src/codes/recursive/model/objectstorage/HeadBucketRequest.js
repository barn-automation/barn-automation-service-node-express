/**
 * A class that contains properties necessary to perform HeadBucket
...
class HeadBucketRequest {
	...
	constructor(namespaceName, bucketName, ifMatch, ifNoneMatch, opcClientRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = HeadBucketRequest;