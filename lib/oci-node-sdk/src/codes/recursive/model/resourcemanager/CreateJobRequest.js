/**
 * A class that contains properties necessary to perform CreateJob
 * @param {CreateJobDetails} createJobDetails An instance of {@link CreateJobDetails}
...
class CreateJobRequest {
	...
	constructor(createJobDetails, opcRequestId, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createJobDetails;
...
module.exports = CreateJobRequest;