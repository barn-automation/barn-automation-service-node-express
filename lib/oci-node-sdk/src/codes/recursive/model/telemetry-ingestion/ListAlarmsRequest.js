/**
 * A class that contains properties necessary to perform ListAlarms
 ...
 * @param {string} [lifecycleState] A filter to return only alarms that match the given lifecycle state exactly. When not specified, only alarms in the ACTIVE lifecycle state are listed.
...
class ListAlarmsRequest {
	...
	constructor(compartmentId, page, limit, displayName, lifecycleState, sortBy, sortOrder, compartmentIdInSubtree, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListAlarmsRequest;