...
* @param {string} severity The perceived type of response required when the alarm is in the "FIRING" state. Example: CRITICAL
...
*/
class CreateAlarmDetails {
	constructor(displayName, compartmentId, metricCompartmentId, namespace, query, severity, destinations, isEnabled, metricCompartmentIdInSubtree, resolution, pendingDuration, body, repeatNotificationDuration, suppression, freeformTags, definedTags){
...
module.exports = CreateAlarmDetails;
