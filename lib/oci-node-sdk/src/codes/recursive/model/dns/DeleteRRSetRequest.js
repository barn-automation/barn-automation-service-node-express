/**
 * A class that contains properties necessary to perform DeleteRRSet
 ...
 * @class DeleteRRSetRequest
 */
class DeleteRRSetRequest {

	constructor(zoneNameOrId, domain, rtype, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteRRSetRequest;