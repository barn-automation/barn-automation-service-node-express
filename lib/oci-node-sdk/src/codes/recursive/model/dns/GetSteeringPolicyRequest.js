/**
 * A class that contains properties necessary to perform GetSteeringPolicy
 ...
 * @class GetSteeringPolicyRequest
 */
class GetSteeringPolicyRequest {

	constructor(steeringPolicyId, ifNoneMatch, ifModifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = GetSteeringPolicyRequest;