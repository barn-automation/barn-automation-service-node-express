/**
 * A class that contains properties necessary to perform UpdateZoneRecords
 * @param {string} zoneNameOrId The name or OCID of the target zone.
 * @param {UpdateZoneRecordsDetails} updateZoneRecordsDetails An instance of {@link UpdateZoneRecordsDetails}
 ...
 * @class UpdateZoneRecordsRequest
 */
class UpdateZoneRecordsRequest {

	constructor(zoneNameOrId, updateZoneRecordsDetails, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateZoneRecordsDetails;
...
module.exports = UpdateZoneRecordsRequest;