...
* @class CreateSteeringPolicyDetails
*/
class CreateSteeringPolicyDetails {
	constructor(compartmentId, displayName, template, ttl, healthCheckMonitorId, freeformTags, definedTags, answers, rules){
...
module.exports = CreateSteeringPolicyDetails;
