/**
 * A class that contains properties necessary to perform DeleteSteeringPolicyAttachment
 ...
 * @class DeleteSteeringPolicyAttachmentRequest
 */
class DeleteSteeringPolicyAttachmentRequest {

	constructor(steeringPolicyAttachmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteSteeringPolicyAttachmentRequest;