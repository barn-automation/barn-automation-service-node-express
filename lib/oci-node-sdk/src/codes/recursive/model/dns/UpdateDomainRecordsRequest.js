/**
 * A class that contains properties necessary to perform UpdateDomainRecords
 ...
 * @param {UpdateDomainRecordsDetails} updateDomainRecordsDetails An instance of {@link UpdateDomainRecordsDetails}
 ...
 * @class UpdateDomainRecordsRequest
 */
class UpdateDomainRecordsRequest {

	constructor(zoneNameOrId, domain, updateDomainRecordsDetails, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateDomainRecordsDetails;
...
module.exports = UpdateDomainRecordsRequest;