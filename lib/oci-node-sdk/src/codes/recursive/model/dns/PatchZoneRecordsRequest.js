/**
 * A class that contains properties necessary to perform PatchZoneRecords
 * @param {string} zoneNameOrId The name or OCID of the target zone.
 * @param {PatchZoneRecordsDetails} patchZoneRecordsDetails An instance of {@link PatchZoneRecordsDetails}
 ...
 * @class PatchZoneRecordsRequest
 */
class PatchZoneRecordsRequest {

	constructor(zoneNameOrId, patchZoneRecordsDetails, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = patchZoneRecordsDetails;
...
module.exports = PatchZoneRecordsRequest;