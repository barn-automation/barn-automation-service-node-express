/**
 * A class that contains properties necessary to perform PatchDomainRecords
 ...
 * @param {PatchDomainRecordsDetails} patchDomainRecordsDetails An instance of {@link PatchDomainRecordsDetails}
 ...
 * @class PatchDomainRecordsRequest
 */
class PatchDomainRecordsRequest {

	constructor(zoneNameOrId, domain, patchDomainRecordsDetails, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = patchDomainRecordsDetails;
...
module.exports = PatchDomainRecordsRequest;