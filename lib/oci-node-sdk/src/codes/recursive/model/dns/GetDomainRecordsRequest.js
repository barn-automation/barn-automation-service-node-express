/**
 * A class that contains properties necessary to perform GetDomainRecords
 ...
 * @param {string} [sortBy] The field by which to sort records. Allowed values are: rtype ttl
...
class GetDomainRecordsRequest {
	...
	constructor(zoneNameOrId, domain, limit, page, zoneVersion, rtype, sortBy, sortOrder, compartmentId, ifNoneMatch, ifModifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = GetDomainRecordsRequest;