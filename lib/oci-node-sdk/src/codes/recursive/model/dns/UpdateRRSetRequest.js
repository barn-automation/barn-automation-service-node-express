/**
 * A class that contains properties necessary to perform UpdateRRSet
 ...
 * @param {UpdateRRSetDetails} updateRRSetDetails An instance of {@link UpdateRRSetDetails}
 ...
 * @class UpdateRRSetRequest
 */
class UpdateRRSetRequest {

	constructor(zoneNameOrId, domain, rtype, updateRRSetDetails, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateRRSetDetails;
...
module.exports = UpdateRRSetRequest;