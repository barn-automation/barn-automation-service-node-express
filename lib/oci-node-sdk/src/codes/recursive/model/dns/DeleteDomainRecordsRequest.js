/**
 * A class that contains properties necessary to perform DeleteDomainRecords
...
class DeleteDomainRecordsRequest {
	...
	constructor(zoneNameOrId, domain, compartmentId, ifMatch, ifUnmodifiedSince){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteDomainRecordsRequest;