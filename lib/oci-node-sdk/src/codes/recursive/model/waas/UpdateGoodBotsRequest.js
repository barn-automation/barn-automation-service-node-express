/**
 * A class that contains properties necessary to perform UpdateGoodBots
 ...
 * @param {UpdateGoodBotsDetails} updateGoodBotsDetails An instance of {@link UpdateGoodBotsDetails}
 ...
 * @class UpdateGoodBotsRequest
 */
class UpdateGoodBotsRequest {

	constructor(waasPolicyId, updateGoodBotsDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateGoodBotsDetails;
		this.waasPolicyId = waasPolicyId;
		this.updateGoodBotsDetails = updateGoodBotsDetails;
...
module.exports = UpdateGoodBotsRequest;