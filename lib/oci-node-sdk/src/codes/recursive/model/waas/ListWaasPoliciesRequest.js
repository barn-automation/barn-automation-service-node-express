/**
 * A class that contains properties necessary to perform ListWaasPolicies
 ...
 * @param {string} [sortBy] The value by which policies are sorted in a paginated 'List' call. If unspecified, defaults to timeCreated. Allowed values are: id displayName timeCreated
 ...
 * @param {Array} [id] Filter policies using a list of policy OCIDs.
 * @param {Array} [displayName] Filter policies using a list of display names.
 * @param {Array} [lifecycleState] Filter policies using a list of lifecycle states.
 * @param {string} [timeCreatedGreaterThanOrEqualTo] A filter that matches policies created on or after the specified date and time.
 * @param {string} [timeCreatedLessThan] A filter that matches policies created before the specified date-time.
...
module.exports = ListWaasPoliciesRequest;