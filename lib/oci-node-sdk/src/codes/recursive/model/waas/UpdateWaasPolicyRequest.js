/**
 * A class that contains properties necessary to perform UpdateWaasPolicy
 ...
 * @param {UpdateWaasPolicyDetails} updateWaasPolicyDetails An instance of {@link UpdateWaasPolicyDetails}
 ...
 * @class UpdateWaasPolicyRequest
 */
class UpdateWaasPolicyRequest {

	constructor(waasPolicyId, updateWaasPolicyDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateWaasPolicyDetails;
...
module.exports = UpdateWaasPolicyRequest;