/**
 * A class that contains properties necessary to perform AcceptRecommendations
 ...
 * @param {Buffer} acceptRecommendationsBody The request body
 ...
 * @class AcceptRecommendationsRequest
 */
class AcceptRecommendationsRequest {

	constructor(waasPolicyId, acceptRecommendationsBody, opcRequestId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = acceptRecommendationsBody;
		this.waasPolicyId = waasPolicyId;
		this.acceptRecommendationsBody = acceptRecommendationsBody;
...
module.exports = AcceptRecommendationsRequest;