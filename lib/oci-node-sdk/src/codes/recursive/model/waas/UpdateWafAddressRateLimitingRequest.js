/**
 * A class that contains properties necessary to perform UpdateWafAddressRateLimiting
 ...
 * @param {UpdateWafAddressRateLimitingDetails} updateWafAddressRateLimitingDetails An instance of {@link UpdateWafAddressRateLimitingDetails}
 ...
 * @class UpdateWafAddressRateLimitingRequest
 */
class UpdateWafAddressRateLimitingRequest {

	constructor(waasPolicyId, updateWafAddressRateLimitingDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateWafAddressRateLimitingDetails;
...
module.exports = UpdateWafAddressRateLimitingRequest;