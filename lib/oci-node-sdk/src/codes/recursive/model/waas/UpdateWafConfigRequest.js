/**
 * A class that contains properties necessary to perform UpdateWafConfig
 ...
 * @param {UpdateWafConfigDetails} updateWafConfigDetails An instance of {@link UpdateWafConfigDetails}
 ...
 * @class UpdateWafConfigRequest
 */
class UpdateWafConfigRequest {

	constructor(waasPolicyId, updateWafConfigDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateWafConfigDetails;
...
module.exports = UpdateWafConfigRequest;