/**
 * A class that contains properties necessary to perform UpdateWhitelists
 ...
 * @param {UpdateWhitelistsDetails} updateWhitelistsDetails An instance of {@link UpdateWhitelistsDetails}
...
class UpdateWhitelistsRequest {
	...
	constructor(waasPolicyId, updateWhitelistsDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateWhitelistsDetails;
		this.waasPolicyId = waasPolicyId;
		this.updateWhitelistsDetails = updateWhitelistsDetails;
...
module.exports = UpdateWhitelistsRequest;