/**
 * A class that contains properties necessary to perform CancelWorkRequest
 * @param {string} workRequestId The {@link https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm|OCID} of the work request. This number is generated when work request is created.
 ...
 * @class CancelWorkRequestRequest
 */
class CancelWorkRequestRequest {

	constructor(workRequestId, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = CancelWorkRequestRequest;