/**
 * A class that contains properties necessary to perform DeleteWaasPolicy
 ...
 * @class DeleteWaasPolicyRequest
 */
class DeleteWaasPolicyRequest {

	constructor(waasPolicyId, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteWaasPolicyRequest;