/**
 * A class that contains properties necessary to perform UpdateDeviceFingerprintChallenge
 ...
 * @param {UpdateDeviceFingerprintChallengeDetails} updateDeviceFingerprintChallengeDetails An instance of {@link UpdateDeviceFingerprintChallengeDetails}
 ...
 * @class UpdateDeviceFingerprintChallengeRequest
 */
class UpdateDeviceFingerprintChallengeRequest {

	constructor(waasPolicyId, updateDeviceFingerprintChallengeDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateDeviceFingerprintChallengeDetails;
...
module.exports = UpdateDeviceFingerprintChallengeRequest;