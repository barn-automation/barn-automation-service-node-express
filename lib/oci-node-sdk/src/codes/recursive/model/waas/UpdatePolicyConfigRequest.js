/**
 * A class that contains properties necessary to perform UpdatePolicyConfig
 ...
 * @param {UpdatePolicyConfigDetails} updatePolicyConfigDetails An instance of {@link UpdatePolicyConfigDetails}
 ...
 * @class UpdatePolicyConfigRequest
 */
class UpdatePolicyConfigRequest {

	constructor(waasPolicyId, updatePolicyConfigDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updatePolicyConfigDetails;
...
module.exports = UpdatePolicyConfigRequest;