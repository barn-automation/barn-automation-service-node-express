/**
 * A class that contains properties necessary to perform CreateWaasPolicy
 * @param {CreateWaasPolicyDetails} createWaasPolicyDetails An instance of {@link CreateWaasPolicyDetails}
 ...
 * @class CreateWaasPolicyRequest
 */
class CreateWaasPolicyRequest {

	constructor(createWaasPolicyDetails, opcRequestId, opcRetryToken){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createWaasPolicyDetails;
...
module.exports = CreateWaasPolicyRequest;