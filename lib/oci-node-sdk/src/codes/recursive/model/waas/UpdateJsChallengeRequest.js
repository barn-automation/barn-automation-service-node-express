/**
 * A class that contains properties necessary to perform UpdateJsChallenge
 ...
 * @param {UpdateJsChallengeDetails} updateJsChallengeDetails An instance of {@link UpdateJsChallengeDetails}
 ...
 * @class UpdateJsChallengeRequest
 */
class UpdateJsChallengeRequest {

	constructor(waasPolicyId, updateJsChallengeDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateJsChallengeDetails;
...
module.exports = UpdateJsChallengeRequest;