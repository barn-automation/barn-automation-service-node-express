/**
 * A class that contains properties necessary to perform UpdateProtectionSettings
 ...
 * @param {UpdateProtectionSettingsDetails} updateProtectionSettingsDetails An instance of {@link UpdateProtectionSettingsDetails}
 ...
 * @class UpdateProtectionSettingsRequest
 */
class UpdateProtectionSettingsRequest {

	constructor(waasPolicyId, updateProtectionSettingsDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateProtectionSettingsDetails;
		this.waasPolicyId = waasPolicyId;
		this.updateProtectionSettingsDetails = updateProtectionSettingsDetails;
...
module.exports = UpdateProtectionSettingsRequest;