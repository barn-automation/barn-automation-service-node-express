/**
 * A class that contains properties necessary to perform UpdateThreatFeeds
 ...
 * @param {UpdateThreatFeedsDetails} updateThreatFeedsDetails An instance of {@link UpdateThreatFeedsDetails}
 ...
 * @class UpdateThreatFeedsRequest
 */
class UpdateThreatFeedsRequest {

	constructor(waasPolicyId, updateThreatFeedsDetails, opcRequestId, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateThreatFeedsDetails;
		this.waasPolicyId = waasPolicyId;
		this.updateThreatFeedsDetails = updateThreatFeedsDetails;
...
module.exports = UpdateThreatFeedsRequest;