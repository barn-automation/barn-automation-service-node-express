/**
 * A class that contains properties necessary to perform UpdateHumanInteractionChallenge
 ...
 * @param {UpdateHumanInteractionChallengeDetails} updateHumanInteractionChallengeDetails An instance of {@link UpdateHumanInteractionChallengeDetails}
 ...
 * @class UpdateHumanInteractionChallengeRequest
 */
class UpdateHumanInteractionChallengeRequest {

	constructor(waasPolicyId, updateHumanInteractionChallengeDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateHumanInteractionChallengeDetails;
...
module.exports = UpdateHumanInteractionChallengeRequest;