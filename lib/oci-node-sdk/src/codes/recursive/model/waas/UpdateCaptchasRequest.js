/**
 * A class that contains properties necessary to perform UpdateCaptchas
 ...
 * @param {UpdateCaptchasDetails} updateCaptchasDetails An instance of {@link UpdateCaptchasDetails}
 ...
 * @class UpdateCaptchasRequest
 */
class UpdateCaptchasRequest {

	constructor(waasPolicyId, updateCaptchasDetails, opcRequestId, opcRetryToken, ifMatch){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateCaptchasDetails;
		this.waasPolicyId = waasPolicyId;
		this.updateCaptchasDetails = updateCaptchasDetails;
...
module.exports = UpdateCaptchasRequest;