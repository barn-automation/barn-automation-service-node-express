/**
 * A class that contains properties necessary to perform GetProtectionRule
 ...
 * @param {string} protectionRuleKey The protection rule key.
 ...
 * @class GetProtectionRuleRequest
 */
class GetProtectionRuleRequest {

	constructor(waasPolicyId, protectionRuleKey, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
	...
	get pathParams(){
		...
		this._pathParams['protectionRuleKey'] = this.protectionRuleKey;
...
module.exports = GetProtectionRuleRequest;