/**
 * A class that contains properties necessary to perform GetSEServiceConfiguration
 ...
 * @class GetSEServiceConfigurationRequest
 */
class GetSEServiceConfigurationRequest {

	constructor(domain, serviceEntitlementId, id){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = GetSEServiceConfigurationRequest;