/**
 * A class that contains properties necessary to perform GetPurchaseEntitlements
 ...
 * @class GetPurchaseEntitlementsRequest
 */
class GetPurchaseEntitlementsRequest {

	constructor(domain, ids, limit, offset, orderBy, serviceDefinitionNames, statuses){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = GetPurchaseEntitlementsRequest;