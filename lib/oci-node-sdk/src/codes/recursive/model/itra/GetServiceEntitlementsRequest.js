/**
 * A class that contains properties necessary to perform GetServiceEntitlements
 ...
 * @class GetServiceEntitlementsRequest
 */
class GetServiceEntitlementsRequest {

	constructor(domain, ids, limit, offset, orderBy, purchaseEntitlementId, serviceDefinitionNames, statuses){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = GetServiceEntitlementsRequest;