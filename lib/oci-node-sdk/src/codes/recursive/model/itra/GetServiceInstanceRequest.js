/**
 * A class that contains properties necessary to perform GetServiceInstance
 * @param {string} domain The identity domain name or the IDCS GUID of the resource
 * @param {string} id ServiceInstance unique identifier
...
module.exports = GetServiceInstanceRequest;