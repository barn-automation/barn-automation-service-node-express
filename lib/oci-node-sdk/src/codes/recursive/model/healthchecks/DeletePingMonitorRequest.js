/**
 * A class that contains properties necessary to perform DeletePingMonitor
 ...
 * @class DeletePingMonitorRequest
 */
class DeletePingMonitorRequest {

	constructor(monitorId, ifMatch, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeletePingMonitorRequest;