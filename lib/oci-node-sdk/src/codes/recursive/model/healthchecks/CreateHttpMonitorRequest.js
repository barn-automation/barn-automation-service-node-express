/**
 * A class that contains properties necessary to perform CreateHttpMonitor
 * @param {CreateHttpMonitorDetails} createHttpMonitorDetails An instance of {@link CreateHttpMonitorDetails}
 ...
 * @class CreateHttpMonitorRequest
 */
class CreateHttpMonitorRequest {

	constructor(createHttpMonitorDetails, opcRetryToken, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = createHttpMonitorDetails;
...
module.exports = CreateHttpMonitorRequest;