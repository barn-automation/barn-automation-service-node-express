/**
 * A class that contains properties necessary to perform ListClusters
 * @param {string} compartmentId The OCID of the compartment.
 * @param {Array} [lifecycleState] A cluster lifecycle state to filter on. Can have multiple parameters of this name.
...
class ListClustersRequest {
	...
	constructor(compartmentId, lifecycleState, name, limit, page, sortOrder, sortBy, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = ListClustersRequest;