/**
 * A class that contains properties necessary to perform DeleteWorkRequest
 ...
 * @class DeleteWorkRequestRequest
 */
class DeleteWorkRequestRequest {

	constructor(workRequestId, ifMatch, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
...
module.exports = DeleteWorkRequestRequest;