/**
 * A class that contains properties necessary to perform UpdateNodePool
 * @param {string} nodePoolId The OCID of the node pool.
 * @param {UpdateNodePoolDetails} updateNodePoolDetails An instance of {@link UpdateNodePoolDetails}
...
class UpdateNodePoolRequest {
	...
	constructor(nodePoolId, updateNodePoolDetails, ifMatch, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateNodePoolDetails;
...
module.exports = UpdateNodePoolRequest;