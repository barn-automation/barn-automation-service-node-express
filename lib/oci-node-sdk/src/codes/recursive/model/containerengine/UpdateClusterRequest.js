/**
 * A class that contains properties necessary to perform UpdateCluster
 * @param {string} clusterId The OCID of the cluster.
 * @param {UpdateClusterDetails} updateClusterDetails An instance of {@link UpdateClusterDetails}
...
class UpdateClusterRequest {
	...
	constructor(clusterId, updateClusterDetails, ifMatch, opcRequestId){
		this._headers = {};
		this._pathParams = {};
		this._queryParams = {};
		this.body = '';
		this.body = updateClusterDetails;
...
module.exports = UpdateClusterRequest;